...
const statusBadgeStyles: Record<string, CSSProperties> = {
  ...
  IN_PROGRESS: { backgroundColor: 'rgba(234,126,32,0.15)', color: 'var(--accent)' },
  FAILED: { backgroundColor: 'rgba(239,68,68,0.15)', color: '#EF4444' },
}

const typeBadgeStyles: Record<string, CSSProperties> = {
  GOOGLE_SYNC: { backgroundColor: 'rgba(234,126,32,0.15)', color: 'var(--accent)' },
...
const defaultBadgeStyle: CSSProperties = { backgroundColor: 'rgba(85,85,85,0.15)', color: 'var(--text-muted)' }
